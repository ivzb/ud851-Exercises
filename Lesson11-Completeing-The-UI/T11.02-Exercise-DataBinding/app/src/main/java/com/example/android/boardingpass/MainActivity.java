...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BoardingPassInfo fakePassInfo = FakeDataUtils.generateFakeBoardingPassInfo();
        displayBoardingPassInfo(fakePassInfo);
    }
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat(getString(R.string.timeFormat), Locale.getDefault());
