...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT = 3434;
    private static final int ACTION_DRINK_PENDING_INTENT = 3535;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        ignoreReminderIntent.setAction(ReminderTasks.ACTION_DISSMIS_NOTIFICATION);
